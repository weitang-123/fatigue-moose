...
#ifndef seiler2App_seiler2_u2_H
#define seiler2App_seiler2_u2_H
...
class seiler2_u2:public Kernel
{
public:
    seiler2_u2(const InputParameters &parameters);
...
protected:
    ...
    virtual Real computeQpOffDiagJacobian(unsigned int jvar) override ;
        ...
        // Input parameter
    const Real &_f2;
    const VariableValue &_couple_u1,&_couple_d;
    const VariableGradient &_grad_couple_u1;
    unsigned int _u1_var,_d_var;
